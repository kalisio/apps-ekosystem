...
git clone https://github.com/kalisio/apps-ekosystem.git
cd apps-ekosystem
...
> [!NOTE]
> **apps-ekosystem** follows the [standardJS](https://standardjs.com/) style guide for linting and code consistency.
...
**apps-ekosystem** follows the [Conventional commits specifications](https://www.conventionalcommits.org/en/v1.0.0-beta.3/)
...
apps-ekosystem follows [Semantic Versioning](https://semver.org/) specification. Given a version number
...
Issues can be reported in the [issue tracker](https://github.com/kalisio/apps-ekosystem/issues).
